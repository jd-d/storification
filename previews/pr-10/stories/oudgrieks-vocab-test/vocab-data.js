...
window.VOCAB_DATASETS.push({
  ...
  facts: Array.isArray(window.GREEK_FACTS) ? window.GREEK_FACTS : [],
  data: `
ὁ ἄνθρωπος\tmens
...
ἡ κόρη\tmeisje
οὖν\tdus, dan, nu
οὕτω(ς)\tzo, op deze wijze
πρός + acc\tnaar (toe), tot, tegen
τέλος\ttenslotte
τὸ τέκνον\tkind
...
τὸ πρᾶγμα, πράγματος\tzaak, gebeurtenis
τὸ πῦρ, πυρός\tvuur
ἡ τέχνη\tkunst, vaardigheid
τὸ φῶς, φωτός\t(dag)licht
ὁ ἀνήρ, ἀνδρός\tman
